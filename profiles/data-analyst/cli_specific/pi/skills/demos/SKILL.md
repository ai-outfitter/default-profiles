...
Use this skill when the user asks for `/demos`, `run demo`, `oil demo`, `healthcare demo`, or asks to try the analyst profile on canned demo data.

The data analyst profile intentionally does **not** vendor demo datasets. Demo data is pulled on demand from the legacy DeepWork Frontend R2-backed demo bundle route:
...
- Do not add external DeepWork job folders. Use the jobs bundled in this data analyst profile.
