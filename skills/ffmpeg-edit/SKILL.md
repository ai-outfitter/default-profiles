---
name: ffmpeg-edit
description: "Cut, speed up/slow down, concatenate, and export video with ffmpeg; inspect media with ffprobe"
---

# `/ffmpeg-edit` — Video editing and export with ffmpeg

Use this skill when the user wants to cut a video, remove sections, speed up
...
After exporting, re-transcribe `final.mp4` (see the `transcribe` skill) so
subtitles and chapter metadata match the actual edit.
